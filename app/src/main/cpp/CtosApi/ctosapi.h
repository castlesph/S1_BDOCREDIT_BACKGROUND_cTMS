...
//Printer config item
#define d_PRINTER_CONFIG_MOTOR_PROTECT_METH            1
#define d_PRINTER_CONFIG_FAST_MODE                    2

//Motor protection medhod for config
#define d_PRINTER_CONFIG_MOTOR_PROTECT_WAIT            1
#define d_PRINTER_CONFIG_MOTOR_PROTECT_RTN_ERR        2

//printer fast mode for config
#define d_PRINTER_CONFIG_FAST_MODE_ENABLE            1
#define d_PRINTER_CONFIG_FAST_MODE_DISABLE            0

USHORT CTOS_PrinterGetConfig(BYTE bConfig, INT* pValue);
USHORT CTOS_PrinterSetConfig(BYTE bConfig, INT iValue);
