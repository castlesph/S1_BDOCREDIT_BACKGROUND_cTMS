...
#define SBKMS2_KEYATTRIBUTE_KPK							0x00010000
#define SBKMS2_KEYATTRIBUTE_INTERMEDIATE				0x00020000
...
// SKDeriveMethod method for customize
#define KMS2_SKDERIVEMETHOD_DEFAULT                         0x00
#define KMS2_SKDERIVEMETHOD_NETS_CUSTOMIZED_DATAENCRYPT     0xE0
#define KMS2_SKDERIVEMETHOD_NETS_CUSTOMIZED_DATASIGN     		0xE1
#define KMS2_SKDERIVEMETHOD_NETS_CUSTOMIZED_MAC     				0xE2
...
// default, pSKDeriveData -->
typedef struct
{
     IN BYTE Length;
     IN BYTE* pSK;
}DEFAULT_SK_DERIVE_DATA;
...
}NETS_CUSTOMIZED_SK_DERIVE_DATA;
...
typedef struct
{
     ...
     struct
     {
         ...
         struct
         {
         	IN BYTE SKDeriveMethod;
          IN void *pSKDeriveData;
         }SessionKey;
...
#define KMS2_PINBLOCKTYPE_THAILAND_SCB_BANK     0x10
...
#define KMS2_INTERMEDIATE_KEYGEN_OP_DES_ENCRYPT_REVERSED_KEY_ORDER 9
#define KMS2_INTERMEDIATE_KEYGEN_OP_DES_DECRYPT_REVERSED_KEY_ORDER 10
#define KMS2_INTERMEDIATE_KEYGEN_OP_DES_ENCRYPT_CBC 11
#define KMS2_INTERMEDIATE_KEYGEN_OP_DES_DECRYPT_CBC 12
