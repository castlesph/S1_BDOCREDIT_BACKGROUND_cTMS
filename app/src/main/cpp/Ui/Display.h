...
int vdDispTransTitleCardTypeandTotal(BYTE byTransType, char *msg); //aaronnino for BDOCLG ver 9.0 fix on issue #00139 HAVE A DEFAULT TITLE DISPLAY OF TXN TYPE 3 of 8
