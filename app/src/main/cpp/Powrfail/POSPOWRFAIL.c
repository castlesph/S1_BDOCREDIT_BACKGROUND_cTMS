...
extern BOOL fRePrintPwrFailFlag;
...
int inCTOS_Clearpowrfail(char *szFileName)
{
	...
	vdDebug_LogPrintf("--inCTOS_Clearpowrfail--");
	...
	vdDebug_LogPrintf("CTOS_FileDelete->>inResult=[%d], szFileName=[%s]", inResult, szFileName);
...
int inCTLOS_Updatepowrfail(short inPowrfailtag)
{
	...
	vdDebug_LogPrintf("--inCTLOS_Updatepowrfail--");
	vdDebug_LogPrintf("inPowrfailtag=[%d]", inPowrfailtag);
	...
	put_env_int("PWRF_STATE", inPowrfailtag);
	inCTOSS_PutEnvDB("PWRF_APPNAME", "CREDIT");
