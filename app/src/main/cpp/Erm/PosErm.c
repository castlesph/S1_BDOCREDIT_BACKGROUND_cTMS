...
#include "Poserm.h"
//#include "ERMDefine.h"
#define ERM_RECEIPT_FILE		    "/data/data/pub/logo.bmp"
#define LOCAL_RECEIPT_FILE			"/data/data/com.Source.S1_BDO.BDO/logo.bmp"
#define ERM_BUFF_FILE				"/data/data/pub/ermbuff.txt"
#define ERM_RECVVIS_FILE			"/data/data/pub/ermrecvvia.txt"
...
int inCTOSS_ERM_Form_Receipt(int inSettle)
{
	...
	//vdCTOSS_SIGPField61();
	vdDebug_LogPrintf("inCTOSS_FormERMReceipt - START");  //Tine:  for logs purposes
