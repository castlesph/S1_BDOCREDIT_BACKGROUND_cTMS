...
{
	int result;
	char *sql = "SELECT GPTid, szGPTAPN, szGPTUserName, szGPTPassword, szGPTPriTxnHostIP, szGPTSecTxnHostIP, szGPTPriSettlementHostIP, szGPTSecSettlementHostIP, inGPTPriTxnHostPortNum, inGPTSecTxnHostPortNum, inGPTPriSettlementHostPort, inGPTSecSettlementHostPort, szGPTTMSHostIP, szGPTTLSHostIP, inGPTTMSHostPortNum, inGPTTLSHostPortNum FROM GPT WHERE GPTid = ?";
	...
	do {
		...
		if (result == SQLITE_ROW) { /* can read data */
			...
			/* szGPTTMSHostIP*/
			strcpy((char*)strGPT.szGPTTMSHostIP, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));

			/* szGPTTLSHostIP*/
			strcpy((char*)strGPT.szGPTTLSHostIP, (char *)sqlite3_column_text(stmt,inStmtSeq +=1 ));

			/* inGPTTMSHostPortNum*/
			strGPT.inGPTTMSHostPortNum = sqlite3_column_int(stmt, inStmtSeq +=1 );

			/* inGPTTLSHostPortNum*/
			strGPT.inGPTTLSHostPortNum = sqlite3_column_int(stmt, inStmtSeq +=1 );
...
{
	int result;
	char *sql = "UPDATE GPT SET szGPTAPN=?, szGPTUserName=?, szGPTPassword=?, szGPTPriTxnHostIP=?, szGPTSecTxnHostIP=?, szGPTPriSettlementHostIP=?, szGPTSecSettlementHostIP=?, inGPTPriTxnHostPortNum=?, inGPTSecTxnHostPortNum=?, inGPTPriSettlementHostPort=?, inGPTSecSettlementHostPort=?, szGPTTMSHostIP=?, szGPTTLSHostIP=?, inGPTTMSHostPortNum=?, inGPTTLSHostPortNum=? WHERE GPTid = ?";
	...
	/*szGPTTMSHostIP*/
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strGPT.szGPTTMSHostIP, strlen((char*)strGPT.szGPTPriSettlementHostIP), SQLITE_STATIC);

	/*szGPTTLSHostIP*/
	result = sqlite3_bind_text(stmt, inStmtSeq +=1, (char*)strGPT.szGPTTLSHostIP, strlen((char*)strGPT.szGPTSecSettlementHostIP), SQLITE_STATIC);

	/* inGPTTMSHostPortNum*/
	result = sqlite3_bind_int(stmt, inStmtSeq +=1, strGPT.inGPTTMSHostPortNum);

	/* inGPTTLSHostPortNum*/
	result = sqlite3_bind_int(stmt, inStmtSeq +=1, strGPT.inGPTTLSHostPortNum);
