...
typedef enum
{
	...
	//FOR PHQR
	d_IPC_CMD_PHQR_SALE         = 0x4c,
	d_IPC_CMD_PHQR_RETRIEVE 	= 0x4d,
	
	//END-QRPAY

	d_IPC_CMD_PRINT_EMV_TAGS    = 0x49,

	d_IPC_CMD_SMAC_KIT_SALE 	= 0x50,
	d_IPC_CMD_SMAC_RENEWAL 		= 0x51,
	d_IPC_CMD_SMAC_PTS_AWARDING	= 0x52,
