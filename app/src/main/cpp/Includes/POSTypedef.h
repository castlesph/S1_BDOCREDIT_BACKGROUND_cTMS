...
#define LOCAL_PATH 					"/data/data/com.Source.S1_BDO.BDO/"
...
//#define MAX_CHAR_PER_LINE       40               //Tine:  03Apr2019
...
#define MANAGEMENT    			155
#define CTMS_UPDATE    			156
#define CLEAR_BATCH    			157
#define CLEAR_REVERSAL   		158
...
#define CVV2_BYTES                 4
#define CARD_HOLD_NAME_DIGITS      75 //30
...
//for EMV offline decline
#define CTLS_EMV_OFFLINE_DECLINE	  -1012
...
/* MCC: Added settlement reconciliation return state -- jzg */
#define ST_CLS_BATCH_ERR (-6)
//int inAccountType;
...
#define MSG_TYPE_PRINT      6
#define MSG_TYPE_PROCESS    7
#define MSG_TYPE_SEND       8
#define MSG_TYPE_RECEIVE    9
#define MSG_TYPE_WAIT       10
#define MSG_TYPE_TIMEOUT    11
#define MSG_TYPE_REMOVE     12


#define MSG_PLS_WAIT       "Please wait"
#define MSG_PROCESSING     "Processing..."
#define MSG_PRINTING       "Printing..."
#define MSG_SELECT_WALLET  "Select a mobile wallet"
#define MSG_TAP_CONTINUE  	"Tap to continue"

#define TRANS_DETAIL_FILE   "/data/data/pub/transdetailfile.dat"
#define EDIT_FILE   	   "/data/data/pub/editfile.dat"
#define FLD_TYPE_STRING    0
#define FLD_TYPE_NUMERIC   1
#define FLD_TYPE_BOOLEAN   2
#define DELIM_CARET        "^"
#define DELIM_PIPE         "|"

#define BUTTON_TYPE_CANCEL_OK       1
#define BUTTON_TYPE_NO_YES   	    2
#define BUTTON_TYPE_CANCEL_CONFIRM  3
#define BUTTON_TYPE_CANCEL_LOGIN    4
#define BUTTON_TYPE_CANCEL_SET      5
#define BUTTON_TYPE_CANCEL_TRYAGAIN 6
#define BUTTON_TYPE_CANCEL_LOGOUT	7
#define BUTTON_TYPE_CANCEL_ENTER	8
#define BUTTON_TYPE_CANCEL_PROCEED	9
#define BUTTON_TYPE_CANCEL_UPLOAD	10
#define BUTTON_TYPE_CANCEL_PRINT_UPLOAD	11
#define BUTTON_TYPE_CANCEL_PRINT	12
#define BUTTON_TYPE_CANCEL_PROCEED_PRINT	13
#define BUTTON_TYPE_CANCEL_OK_PRINT 14
#define BUTTON_TYPE_NONE_FINISH   	15
#define BUTTON_TYPE_NONE_OK   		16
#define BUTTON_TYPE_NONE_BACK_TO_MAIN 17


#define MENU_TEXT_VIEW				1
#define MENU_IMAGE_VIEW				2
#define MENU_TEXT_IMAGE_VIEW		3


#define MENU_1_COL_COUNT				1
#define MENU_2_COL_COUNT				2
#define MENU_3_COL_COUNT				3
...
//smac	
  ...
  BYTE fCUPPINEntry;
  BOOL fEMVPINEntered; //Pin entered
  BOOL fEMVPINBYPASS;
  BYTE szKSN[10+1];
  BOOL fInstallment;
...
#define V5S_BDOCREDIT "com.Source.S1_BDO.BDO"
#define V5S_BDODEBIT "com.Source.S1_CLGDEBIT.CLGDEBIT"
#define V5S_BDOINST "com.Source.S1_BDOINST.BDOINST"
#define V5S_BDOPAY "com.Source.S1_QRPAY.QRPAY"
#define V5S_BDOCUP "com.Source.S1_BDOCUP.BDOCUP"
...
#define ANDROID_NEW_UI

#define HOSTNAME_BUFFER_SIZE        9999

#define NUMERIC_INPUT_TYPE			1
#define ALPHANUM_INPUT_TYPE			2
#define NUMPHONE_INPUT_TYPE			3
...
#define BDO_LOYALTY_ISSUER_INDEX   35
