...
#define DB_ENV_CFG 					"/data/data/pub/ENV.S3DB"
...
int inCTOSS_BackupDataScript(unsigned char *szScriptFile, unsigned char *szOutputFile);
int inCTOSS_RestoreDataByScript(void);
