...
//SMAC
	...
	{"vdCTOS_EditIssuer",vdCTOS_EditIssuer},
	{"inCTOS_Management",inCTOS_Management},

	// Additional functionality
	{"vdCTOS_Ping",vdCTOS_Ping},
	{"vdCTOS_TelNet",vdCTOS_TelNet},
	{"inCTOS_SelectReviewMenu",inCTOS_SelectReviewMenu},
	{"inReportSelecion",inReportSelecion},
	{"inReprintSelection",inReprintSelection},
	{"inCTOS_Hotel", inCTOS_Hotel},
...
Func_inISOPack stFunctionList_inISOPack[] = {
	...
	{"inPackIsoFunc53", inPackIsoFunc53},
	...
	{"inCUPPackIsoFunc61", inCUPPackIsoFunc61},
...
int inCTOSS_ExeFunction(char *INuszFunctionName)
{
	...
	vdDebug_LogPrintf("--inCTOSS_ExeFunction--");
	vdDebug_LogPrintf("INuszFunctionName=[%s]", INuszFunctionName);
...
int inCTOS_Retrieve(void)
{
   ...
   strcpy(szGlobalAPName,"com.Source.S1_QRPAY.QRPAY");  
