...
public class AmountEntryActivity extends DemoAppActivity {
    ...
    Button btnKey1, btnKey2, btnKey3,btnKey4,btnKey5,btnKey6,btnKey7,btnKey8,btnKey9,btnKey0,btnKeyEnter,btnKeyCancel,btnKeyClear,btnKey00,btnKey000;
    Button btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKey00=(Button) findViewById(R.id.ibtnDoubleZero);
        btnKey000=(Button) findViewById(R.id.ibtnTripleZero);
    ...
    public void FuncKey00() {
        btnKey00.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Log.i(TAG, "FuncKey00: amountmaxlength="+amountmaxlength+",Amount.length()="+Amount.length()+",Amount="+Amount+",txtViewAmount.getText()="+txtViewAmount.getText().toString());
                if(Amount.length() <= 0)
                    return;
                ...
                {
                    Amount = Amount + "00";
                    Amount = (Amount.length() > amountmaxlength ? Amount.substring(0, amountmaxlength) : Amount);
                }
    ...
    public void FuncKey000() {
        btnKey000.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                getTimerRestart();

                Log.i(TAG, "FuncKey000: amountmaxlength="+amountmaxlength+",Amount.length()="+Amount.length()+",Amount="+Amount);
                if(Amount.length() <= 0)
                    return;
