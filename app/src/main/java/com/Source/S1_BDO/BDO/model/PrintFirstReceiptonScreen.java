...
public class PrintFirstReceiptonScreen extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firstreceipt_on_screen);
        ...
        for (int inIdx = 0; inIdx < msgcnt; inIdx++) {
            ...
            switch (inIdx) {
                ...
                case 1:
                    ...
                    btn_proceed.setText(dispmsginfo[inIdx]);
                    break;
                case 2:
        ...
        btn_proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PrintFirstReceiptonScreen.this.finish();
    ...
    private CountDownTimer timer = new CountDownTimer(inTimeOut*1000, 1000) {
        ...
        public void onTick(long millisUntilFinished) {
            Log.i("Timer", "PrintFirstReceiptonScreen Timer onTick");
        }

        @Override
        public void onFinish() {
            Log.i("Timer", "PrintFirstReceiptonScreen Timer onFinish");

            //etInputStr.clear();
            final_string = "TIME OUT";

            //startActivity(new Intent(PrintFirstReceiptonScreen.this, MainActivity.class));
