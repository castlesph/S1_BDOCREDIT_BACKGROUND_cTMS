...
import com.Source.S1_BDO.BDO.filechooser.ChooserDialog;
...
public class ChooseFileActivityFragment extends Fragment implements View.OnClickListener {
                ...
                new ChooserDialog(ctx)
                    ...
                    .withChosenListener(new ChooserDialog.Result() {
                        ...
                        public void onChoosePath(String path, File pathFile) {
                            ...
                            Intent intent = new Intent(ctx, DatabaseManager.class);
                            intent.putExtra("Key_DBName", path);
    ...
    public void onClick(View v) {
        ...
        ChooserDialog show = new ChooserDialog(ctx)
