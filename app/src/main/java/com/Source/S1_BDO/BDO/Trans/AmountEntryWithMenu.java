...
public class AmountEntryWithMenu extends DemoAppActivity {
    ...
    Button btnKey1, btnKey2, btnKey3,btnKey4,btnKey5,btnKey6,btnKey7,btnKey8,btnKey9,btnKey0,btnKeyEnter,btnKeyCancel,btnKeyClear,btnKeyMenu;
    Button btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amount_sale);
        ...
        btnKeyEnter=(Button) findViewById(R.id.ibtnEnter);
		btnKeyMenu=(Button) findViewById(R.id.ibtnMenu);
        ...
        btnKeyCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Amount.length() > 0){
                    ...
                    //startActivity(new Intent(AmountEntryWithMenu.this, MainActivity.class));
                    AmountEntryWithMenu.this.finish();

                    Log.i("saturn", "saturn Get Amount KeyBoard buCancel");
    ...
    public void FuncKeyMenu() {
        btnKeyMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

				getTimerCancel();
                //Toast.makeText(getApplicationContext(), "Cancelling...", Toast.LENGTH_SHORT).show();
                final_amt_string = "MENU";
                //startActivity(new Intent(AmountEntryWithMenu.this, MainActivity.class));
                AmountEntryWithMenu.this.finish();

                Log.i("saturn", "saturn Get Amount KeyBoard btnKeyMenu");
                // do whatever you need in child activity, but once you want to finish, do this and continue in parent activity
                synchronized (MainActivity.LOCK) {
                MainActivity.LOCK.setCondition(true);
                MainActivity.LOCK.notifyAll();        
