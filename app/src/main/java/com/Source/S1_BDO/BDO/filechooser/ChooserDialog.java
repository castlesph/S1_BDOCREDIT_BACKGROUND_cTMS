package com.Source.S1_BDO.BDO.filechooser;
...
import com.Source.S1_BDO.BDO.filechooser.internals.ExtFileFilter;
import com.Source.S1_BDO.BDO.filechooser.internals.FileUtil;
import com.Source.S1_BDO.BDO.filechooser.internals.RegexFileFilter;
import com.Source.S1_BDO.BDO.filechooser.internals.UiUtil;
import com.Source.S1_BDO.BDO.filechooser.tool.DirAdapter;
...
import static com.Source.S1_BDO.BDO.filechooser.internals.FileUtil.NewFolderFilter;
                        ...
                        public void onClick(final View view) {
                            if (_options == null) {
                                ...
                                final int rootId = _context.getResources().getIdentifier("contentPanel", "id",
                                    "android");
                                final FrameLayout root = (FrameLayout) ((AlertDialog) dialog).findViewById(rootId);
