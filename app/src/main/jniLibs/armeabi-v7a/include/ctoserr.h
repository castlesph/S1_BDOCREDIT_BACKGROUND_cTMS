...
#define d_SYSTEM_NOT_SUPPORT				0x0205
#define d_SYSTEM_INSUFFICIENT_BUF			0x0206
...
// Touch Signature.
/*
  The error number from 0x3201 to 0x320F are using by Signature.so of plug-in.
  The newest error code need start from 0x3210.
*/
...
// BMP Convert.
/*
 The error number from 0x3301 to 0x330F are using by BMP convert plug-in.
 (2015/10/20 . The BMP convert function are content in Signature.so plug-in.
 The 
*/
...
// MDB Error
#define d_MDB_HAL_FAULT					0x3501
#define d_MDB_TRANSACTION_FAIL				0x3502
#define d_MDB_INSUFFICIENT_CMD_BUF			0x3503
#define d_MDB_LEVEL_NOT_SUPPORT				0x3504
...
#define d_WIFI_AP_NOT_CONNECTED				0x4308
#define d_WIFI_NOT_SUPPORTED				0x4309 
...
#define d_BLUETOOTH_CONNECTION_TERMINATED	0x450E
...
#define d_CTMS_FORMAT_INVALID				0x570A
...
#define d_CL_NOT_SUPPORTED						0x83BC
